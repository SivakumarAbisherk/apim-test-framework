...
public class GraphQlSchemaIndividualApi {
     ...
     */
    public okhttp3.Call getAPIGraphQLSchemaCall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String accept, @jakarta.annotation.Nullable String ifNoneMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAPIGraphQLSchemaValidateBeforeCall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String accept, @jakarta.annotation.Nullable String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiId' is set
        if (apiId == null) {
            throw new ApiException("Missing the required parameter 'apiId' when calling getAPIGraphQLSchema(Async)");
        }

        return getAPIGraphQLSchemaCall(apiId, accept, ifNoneMatch, _callback);
     ...
     */
    public GraphQLSchemaDTO getAPIGraphQLSchema(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String accept, @jakarta.annotation.Nullable String ifNoneMatch) throws ApiException {
     ...
     */
    public ApiResponse<GraphQLSchemaDTO> getAPIGraphQLSchemaWithHttpInfo(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String accept, @jakarta.annotation.Nullable String ifNoneMatch) throws ApiException {
     ...
     */
    public okhttp3.Call getAPIGraphQLSchemaAsync(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String accept, @jakarta.annotation.Nullable String ifNoneMatch, final ApiCallback<GraphQLSchemaDTO> _callback) throws ApiException {
