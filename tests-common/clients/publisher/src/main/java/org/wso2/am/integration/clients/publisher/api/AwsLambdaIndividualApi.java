...
public class AwsLambdaIndividualApi {
     ...
     */
    public okhttp3.Call getAmazonResourceNamesOfAPICall(@jakarta.annotation.Nonnull String apiId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAmazonResourceNamesOfAPIValidateBeforeCall(@jakarta.annotation.Nonnull String apiId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiId' is set
        if (apiId == null) {
            throw new ApiException("Missing the required parameter 'apiId' when calling getAmazonResourceNamesOfAPI(Async)");
        }

        return getAmazonResourceNamesOfAPICall(apiId, _callback);
     ...
     */
    public String getAmazonResourceNamesOfAPI(@jakarta.annotation.Nonnull String apiId) throws ApiException {
     ...
     */
    public ApiResponse<String> getAmazonResourceNamesOfAPIWithHttpInfo(@jakarta.annotation.Nonnull String apiId) throws ApiException {
     ...
     */
    public okhttp3.Call getAmazonResourceNamesOfAPIAsync(@jakarta.annotation.Nonnull String apiId, final ApiCallback<String> _callback) throws ApiException {
