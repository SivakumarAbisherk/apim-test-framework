...
import org.wso2.am.integration.clients.publisher.api.dto.AuditReportDTO;
...
public class ApiAuditApi {
     ...
     */
    public okhttp3.Call getAuditReportOfAPICall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String accept, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAuditReportOfAPIValidateBeforeCall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String accept, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiId' is set
        if (apiId == null) {
            throw new ApiException("Missing the required parameter 'apiId' when calling getAuditReportOfAPI(Async)");
        }

        return getAuditReportOfAPICall(apiId, accept, _callback);
     ...
     */
    public AuditReportDTO getAuditReportOfAPI(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String accept) throws ApiException {
     ...
     */
    public ApiResponse<AuditReportDTO> getAuditReportOfAPIWithHttpInfo(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String accept) throws ApiException {
     ...
     */
    public okhttp3.Call getAuditReportOfAPIAsync(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String accept, final ApiCallback<AuditReportDTO> _callback) throws ApiException {
