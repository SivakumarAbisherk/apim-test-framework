...
import org.wso2.am.integration.clients.publisher.api.dto.APIExternalStoreListDTO;
import org.wso2.am.integration.clients.publisher.api.dto.ErrorDTO;
import org.wso2.am.integration.clients.publisher.api.dto.ExternalStoreDTO;
...
public class ExternalStoresApi {
    ...
    private okhttp3.Call getAllExternalStoresValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getAllExternalStoresCall(_callback);
     ...
     */
    public okhttp3.Call getAllPublishedExternalStoresByAPICall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllPublishedExternalStoresByAPIValidateBeforeCall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        ...
        return getAllPublishedExternalStoresByAPICall(apiId, ifNoneMatch, _callback);
     ...
     */
    public APIExternalStoreListDTO getAllPublishedExternalStoresByAPI(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String ifNoneMatch) throws ApiException {
     ...
     */
    public ApiResponse<APIExternalStoreListDTO> getAllPublishedExternalStoresByAPIWithHttpInfo(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String ifNoneMatch) throws ApiException {
     ...
     */
    public okhttp3.Call getAllPublishedExternalStoresByAPIAsync(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String ifNoneMatch, final ApiCallback<APIExternalStoreListDTO> _callback) throws ApiException {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK. API was successfully published to all the selected external stores.  </td><td>  * ETag - Entity Tag of the response resource. Used by caches, or in conditional requests (Will be supported in future).  <br>  * Last-Modified - Date and time the resource has beed modified the last time. Use &#x3D;d by caches, or in conditional requests (Will be supported in future).  <br>  </td></tr>
        <tr><td> 404 </td><td> Not Found. The specified resource does not exist. </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Internal Server Error. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call publishAPIToExternalStoresCall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String externalStoreIds, @jakarta.annotation.Nullable String ifMatch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call publishAPIToExternalStoresValidateBeforeCall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String externalStoreIds, @jakarta.annotation.Nullable String ifMatch, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiId' is set
        if (apiId == null) {
            throw new ApiException("Missing the required parameter 'apiId' when calling publishAPIToExternalStores(Async)");
        }

        return publishAPIToExternalStoresCall(apiId, externalStoreIds, ifMatch, _callback);
     ...
     */
    public APIExternalStoreListDTO publishAPIToExternalStores(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String externalStoreIds, @jakarta.annotation.Nullable String ifMatch) throws ApiException {
     ...
     */
    public ApiResponse<APIExternalStoreListDTO> publishAPIToExternalStoresWithHttpInfo(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String externalStoreIds, @jakarta.annotation.Nullable String ifMatch) throws ApiException {
     ...
     */
    public okhttp3.Call publishAPIToExternalStoresAsync(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable String externalStoreIds, @jakarta.annotation.Nullable String ifMatch, final ApiCallback<APIExternalStoreListDTO> _callback) throws ApiException {
