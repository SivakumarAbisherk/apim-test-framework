...
public class GraphQlSchemaApi {
     ...
     */
    public okhttp3.Call updateAPIGraphQLSchemaCall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nonnull String schemaDefinition, @jakarta.annotation.Nullable String ifMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call updateAPIGraphQLSchemaValidateBeforeCall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nonnull String schemaDefinition, @jakarta.annotation.Nullable String ifMatch, final ApiCallback _callback) throws ApiException {
        ...
        return updateAPIGraphQLSchemaCall(apiId, schemaDefinition, ifMatch, _callback);
     ...
     */
    public void updateAPIGraphQLSchema(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nonnull String schemaDefinition, @jakarta.annotation.Nullable String ifMatch) throws ApiException {
     ...
     */
    public ApiResponse<Void> updateAPIGraphQLSchemaWithHttpInfo(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nonnull String schemaDefinition, @jakarta.annotation.Nullable String ifMatch) throws ApiException {
     ...
     */
    public okhttp3.Call updateAPIGraphQLSchemaAsync(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nonnull String schemaDefinition, @jakarta.annotation.Nullable String ifMatch, final ApiCallback<Void> _callback) throws ApiException {
