...
public class WorkflowResponseDTO {
  ...
  public WorkflowResponseDTO workflowStatus(@jakarta.annotation.Nonnull WorkflowStatusEnum workflowStatus) {
  ...
  public void setWorkflowStatus(@jakarta.annotation.Nonnull WorkflowStatusEnum workflowStatus) {
    this.workflowStatus = workflowStatus;
  }


  public WorkflowResponseDTO jsonPayload(@jakarta.annotation.Nullable String jsonPayload) {
  ...
  public void setJsonPayload(@jakarta.annotation.Nullable String jsonPayload) {
    this.jsonPayload = jsonPayload;
  }


  public WorkflowResponseDTO lifecycleState(@jakarta.annotation.Nullable LifecycleStateDTO lifecycleState) {
  ...
  public void setLifecycleState(@jakarta.annotation.Nullable LifecycleStateDTO lifecycleState) {
    this.lifecycleState = lifecycleState;
  }
  ...
  static {
    ...
    openapiRequiredFields.add("workflowStatus");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WorkflowResponseDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowResponseDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowResponseDTO is not found in the empty JSON string", WorkflowResponseDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowResponseDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowResponseDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkflowResponseDTO.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("workflowStatus").isJsonPrimitive()) {
      ...
      // validate the required field `workflowStatus`
      WorkflowStatusEnum.validateJsonElement(jsonObj.get("workflowStatus"));
      ...
      if (jsonObj.get("lifecycleState") != null && !jsonObj.get("lifecycleState").isJsonNull()) {
        LifecycleStateDTO.validateJsonElement(jsonObj.get("lifecycleState"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowResponseDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowResponseDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowResponseDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowResponseDTO.class));
   ...
   * @throws IOException if the JSON string is invalid with respect to WorkflowResponseDTO
   */
