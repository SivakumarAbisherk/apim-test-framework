...
import org.wso2.am.integration.clients.publisher.api.dto.GraphQLQueryComplexityInfoDTO;
import org.wso2.am.integration.clients.publisher.api.dto.GraphQLSchemaTypeListDTO;
...
public class GraphQlPoliciesApi {
     ...
     */
    public okhttp3.Call getGraphQLPolicyComplexityOfAPICall(@jakarta.annotation.Nonnull String apiId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getGraphQLPolicyComplexityOfAPIValidateBeforeCall(@jakarta.annotation.Nonnull String apiId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiId' is set
        if (apiId == null) {
            throw new ApiException("Missing the required parameter 'apiId' when calling getGraphQLPolicyComplexityOfAPI(Async)");
        }

        return getGraphQLPolicyComplexityOfAPICall(apiId, _callback);
     ...
     */
    public GraphQLQueryComplexityInfoDTO getGraphQLPolicyComplexityOfAPI(@jakarta.annotation.Nonnull String apiId) throws ApiException {
     ...
     */
    public ApiResponse<GraphQLQueryComplexityInfoDTO> getGraphQLPolicyComplexityOfAPIWithHttpInfo(@jakarta.annotation.Nonnull String apiId) throws ApiException {
     ...
     */
    public okhttp3.Call getGraphQLPolicyComplexityOfAPIAsync(@jakarta.annotation.Nonnull String apiId, final ApiCallback<GraphQLQueryComplexityInfoDTO> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getGraphQLPolicyComplexityTypesOfAPICall(@jakarta.annotation.Nonnull String apiId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getGraphQLPolicyComplexityTypesOfAPIValidateBeforeCall(@jakarta.annotation.Nonnull String apiId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiId' is set
        if (apiId == null) {
            throw new ApiException("Missing the required parameter 'apiId' when calling getGraphQLPolicyComplexityTypesOfAPI(Async)");
        }

        return getGraphQLPolicyComplexityTypesOfAPICall(apiId, _callback);
     ...
     */
    public GraphQLSchemaTypeListDTO getGraphQLPolicyComplexityTypesOfAPI(@jakarta.annotation.Nonnull String apiId) throws ApiException {
     ...
     */
    public ApiResponse<GraphQLSchemaTypeListDTO> getGraphQLPolicyComplexityTypesOfAPIWithHttpInfo(@jakarta.annotation.Nonnull String apiId) throws ApiException {
     ...
     */
    public okhttp3.Call getGraphQLPolicyComplexityTypesOfAPIAsync(@jakarta.annotation.Nonnull String apiId, final ApiCallback<GraphQLSchemaTypeListDTO> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateGraphQLPolicyComplexityOfAPICall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable GraphQLQueryComplexityInfoDTO graphQLQueryComplexityInfoDTO, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateGraphQLPolicyComplexityOfAPIValidateBeforeCall(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable GraphQLQueryComplexityInfoDTO graphQLQueryComplexityInfoDTO, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiId' is set
        if (apiId == null) {
            throw new ApiException("Missing the required parameter 'apiId' when calling updateGraphQLPolicyComplexityOfAPI(Async)");
        }

        return updateGraphQLPolicyComplexityOfAPICall(apiId, graphQLQueryComplexityInfoDTO, _callback);
     ...
     */
    public void updateGraphQLPolicyComplexityOfAPI(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable GraphQLQueryComplexityInfoDTO graphQLQueryComplexityInfoDTO) throws ApiException {
     ...
     */
    public ApiResponse<Void> updateGraphQLPolicyComplexityOfAPIWithHttpInfo(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable GraphQLQueryComplexityInfoDTO graphQLQueryComplexityInfoDTO) throws ApiException {
     ...
     */
    public okhttp3.Call updateGraphQLPolicyComplexityOfAPIAsync(@jakarta.annotation.Nonnull String apiId, @jakarta.annotation.Nullable GraphQLQueryComplexityInfoDTO graphQLQueryComplexityInfoDTO, final ApiCallback<Void> _callback) throws ApiException {
