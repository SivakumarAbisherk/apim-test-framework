...
import org.wso2.am.integration.clients.publisher.api.dto.SearchResultListDTO;
...
public class UnifiedSearchApi {
     ...
     */
    public okhttp3.Call searchCall(@jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable Integer offset, @jakarta.annotation.Nullable String query, @jakarta.annotation.Nullable String ifNoneMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call searchValidateBeforeCall(@jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable Integer offset, @jakarta.annotation.Nullable String query, @jakarta.annotation.Nullable String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        return searchCall(limit, offset, query, ifNoneMatch, _callback);
     ...
     */
    public SearchResultListDTO search(@jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable Integer offset, @jakarta.annotation.Nullable String query, @jakarta.annotation.Nullable String ifNoneMatch) throws ApiException {
     ...
     */
    public ApiResponse<SearchResultListDTO> searchWithHttpInfo(@jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable Integer offset, @jakarta.annotation.Nullable String query, @jakarta.annotation.Nullable String ifNoneMatch) throws ApiException {
     ...
     */
    public okhttp3.Call searchAsync(@jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable Integer offset, @jakarta.annotation.Nullable String query, @jakarta.annotation.Nullable String ifNoneMatch, final ApiCallback<SearchResultListDTO> _callback) throws ApiException {
