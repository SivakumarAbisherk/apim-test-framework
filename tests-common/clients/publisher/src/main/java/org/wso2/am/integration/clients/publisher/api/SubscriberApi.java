...
import org.wso2.am.integration.clients.publisher.api.dto.SubscriberInfoDTO;
...
public class SubscriberApi {
     ...
     */
    public okhttp3.Call getSubscriberInfoBySubscriptionIdCall(@jakarta.annotation.Nonnull String subscriptionId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getSubscriberInfoBySubscriptionIdValidateBeforeCall(@jakarta.annotation.Nonnull String subscriptionId, final ApiCallback _callback) throws ApiException {
        ...
        return getSubscriberInfoBySubscriptionIdCall(subscriptionId, _callback);
     ...
     */
    public SubscriberInfoDTO getSubscriberInfoBySubscriptionId(@jakarta.annotation.Nonnull String subscriptionId) throws ApiException {
     ...
     */
    public ApiResponse<SubscriberInfoDTO> getSubscriberInfoBySubscriptionIdWithHttpInfo(@jakarta.annotation.Nonnull String subscriptionId) throws ApiException {
     ...
     */
    public okhttp3.Call getSubscriberInfoBySubscriptionIdAsync(@jakarta.annotation.Nonnull String subscriptionId, final ApiCallback<SubscriberInfoDTO> _callback) throws ApiException {
