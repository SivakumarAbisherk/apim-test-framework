...
public abstract class BaseAPIMContainer extends GenericContainer<BaseAPIMContainer> {
    ...
    private static final String API_MANAGER_DIR = "/home/abisherk/Internship/InternProject/apim-test-framework/tests-common/testcontainers/src/main/resources/apim/wso2am-4.5.0";
